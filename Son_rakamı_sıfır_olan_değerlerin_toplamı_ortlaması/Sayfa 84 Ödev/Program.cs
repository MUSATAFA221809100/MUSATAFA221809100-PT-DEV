...
// Yukarıdaki örneği son rakamı sıfır olan değerlerin toplamı ve ortalamasını da verecek şekilde yeniden yaz.

{
    ...
    internal class Program
    {
        ...
        {
            int b,c=0,d;
            Console.WriteLine("Kaç Adet Sayi Giriceksiniz");// ekrana yazar kaç adet sayı gireceksiniz diye
